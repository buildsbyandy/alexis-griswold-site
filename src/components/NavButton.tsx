...
const NavButton: FC<NavButtonProps> = ({ text, href }) => {
  return (
    <a
      href={href}
      className="group flex items-center justify-center p-6 border-2 border-white text-white bg-transparent hover:bg-white hover:text-[#654C37] transition-colors duration-200 rounded-lg shadow-lg"
      role="button"
